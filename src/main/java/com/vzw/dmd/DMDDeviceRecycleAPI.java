...
import com.vzw.dmd.valueobject.*;

public class DMDDeviceRecycleAPI extends HttpServlet implements ILteXmlCreator{
	private static Logger L =
		Logger.getLogger(DMDLogs.getLogName(DMDDeviceRecycleAPI.class));
	/**
	...
	public void defaultAction(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			if((deviceId == null ||deviceId.trim().equals("") )) {
				...
				DeviceRecycleInfo recycleInfo = new DeviceRecycleInfo();
				recycleInfo.setDeviceId(deviceId);
				recycleInfo.setDeviceType(DMDUtils.getDeviceIDType(deviceId));			 
				DeviceLookupDAO.getDeviceRecycleInfo( recycleInfo);
				
				String returnXML = LteXmlCreator.createDeviceRecycleXML(recycleInfo);
