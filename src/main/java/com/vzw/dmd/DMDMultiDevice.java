...
public class DMDMultiDevice extends HttpServlet {
	...
	*/
	public void defaultAction(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			processor.getMultiDeviceData(req.getParameter("xmlReq"), multiDeviceVO);
			
			String returnXML = LteXmlCreator.createmultiDeviceXML(multiDeviceVO);
			String xmlReqLog = req.getParameter("xmlReq");
			L.debug(""+"============");
			L.debug("DMDMultiDevice : requestXML :"+xmlReqLog);
			L.debug("DMDMultiDevice : returnXML :"+returnXML);
			L.debug(""+"============");			
