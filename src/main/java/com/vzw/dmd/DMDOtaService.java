...
import com.vzw.dmd.util.OTAProcessor;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DMDOtaService extends HttpServlet {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger L =
        Logger.getLogger(DMDLogs.getLogName(DMDOtaService.class));
    /**
    ...
    */
    public void defaultAction(HttpServletRequest req, HttpServletResponse res)
        ...
        try{
        	OTAProcessor processor = new OTAProcessor();
            ...
            L.info("DMDOTAService.defaultAction() xmlReq--"+xmlReq);
            
            String statusCode = processor.processMsg(xmlReq);
            
            L.info("DMDOTAService.defaultAction() statusCode--"+statusCode);
            ...
            if(prcTime > 5000) {
                L.info("DMDOTAService: SLOWNESS ALERT: " + prcTime);
            }
        }
    }
