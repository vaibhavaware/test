...
import com.vzw.dmd.util.DMDSimOTAMq;
 ...
 * @author
 */
public class DMDSimOTA extends HttpServlet {

	//private static Logger L = Logger.getLogger(DMDLogs.getLogName(DMDXmlPost.class));
	private static Logger L = Logger.getLogger(DMDLogs.getPibLogName(DMDSimOTA.class));	
	...
	*/
	...
	public void defaultAction(
			...
			try {
				...
				DMDSimOTAMq.processMsgXMLString(xmlReqString);
