	...
	<xsl:template match="/equipment">
		...
		<td valign="top" width="753" height="1000">
			<table cellpadding="2" cellspacing="2" width="80%">
				...
				<tr>
					<td width="520">
						<span class="verdanaBlack10"><center>Accessories</center></span><br/>
						<img>
							...
							<tr>
								<td>
									<table cellpadding="0" cellspacing="1" border="0" width="100%">
										<tr>
											<td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Dymax Code</td>
											<td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Accessory Name</td>
											<td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Accessory Desc</td>
										</tr>
										<xsl:for-each select="accessories">
										<tr>
											<td valign="top" align="center" class="verdanaRed9NB">
												<xsl:value-of select="dymax/@code"/>
											</td>
											<td valign="top" align="center" class="verdanaRed9NB">
												<xsl:value-of select="dymax/name"/>
											</td>
											<td valign="top" align="center" class="verdanaRed9NB">
												<xsl:value-of select="dymax/desc"/>
											</td>
										</tr>
										</xsl:for-each>
									</table>
