			...
			<xsl:if test="$desc_cnt > 0">
				<td valign="top" width="753" height="1000">
					<table cellpadding="2" cellspacing="2" width="80%">
						...
						<tr>
							<td width="753">
								<span class="verdanaBlack10">
									<center>ICCID Features</center>
								</span>
								<table cellpadding="0" cellspacing="0" border="2" bordercolor="#333366" width="80%">
									<tr>
										<td>
											<table cellpadding="0" cellspacing="1" border="0" width="100%">
												...
												<tr>
													...
													<td valign="top" align="center" class="verdanaRed9NB">
														<xsl:value-of select="general_features/item[@type='PROD_TYPE']" />
													</td>
												</tr>
												<tr>
													<td valign="middle" align="center" bgcolor="#CCCCCC" class="verdanaBlue9">SOLDERED_SIM</td>
													<td valign="middle" align="center" bgcolor="#CCCCCC" class="verdanaBlue9">SIM_CAPABLE</td>
												</tr>
												<tr>
													<td valign="top" align="center" class="verdanaRed9NB">
															<xsl:value-of select="general_features/item[@type='SOLDERED_SIM']" />
													</td>
													<td valign="top" align="center" class="verdanaRed9NB">
															<xsl:value-of select="general_features/item[@type='SIM_CAPABLE']" />
													</td>
												</tr>
						...
						<xsl:if test="count(sim_ota/sim_ota_details) > 0">
							<tr>
								<td width="753">
									<span class="verdanaBlack10">
										<center>SIM OTA DETAILS</center>
									</span>
									<table cellpadding="1" cellspacing="0" border="2" bordercolor="#333366" width="100%">
										<tr>
											<td>
												<table rules="all" cellpadding="0" cellspacing="1" frame="border" width="100%">
												  ...
												  <td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Template Name</td>
												  <td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Template Version</td>
												  <td valign="middle" align="center" bgcolor="#CCCCCC" class='verdanaBlue9'>Programmed Date</td>
												  </tr>
												  
												  <xsl:for-each select="sim_ota/sim_ota_details">
													  <tr>
														...
														<td valign="middle" align="center" class="verdanaRed9NB">
															<xsl:value-of select="programmed_date" />
														</td>
													</tr>
												  </xsl:for-each>
